    ...
    <html lang="en">
        ...
        <head>
            ...
            <!-- Template Stylesheet -->
            <link href="css/stylesUpdate.css" rel="stylesheet">
        </head>
        ...
        <body>
            ...
            <div class="container-fluid feature bg-light py-5">
                <div class="container py-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-4" data-bs-toggle="modal" data-bs-target="#daftarKursusModal" style="cursor:pointer;">
                            <div class="feature-icon mb-3"><i class="fas fa-edit text-white fa-3x"></i></div>
                            <a  class="h4 mb-3">Daftar Kursus</a>
                            <p class="mb-3">Isi maklumat kursus baharu.</p>
                        <br>
                        </div>
                    </div>
                    <!-- Card 2 -->
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s" style="cursor:pointer;">
                        <div class="feature-item p-4">
                        <div class="feature-icon mb-3"><i class="fas fa-calendar-alt text-white fa-3x"></i></div>
                        <a href="#" class="h4 mb-3">Tarikh Kursus</a>
                        <p class="mb-3">Semak jadual kursus anda.</p><br>
                        </div>
                    </div>
                    <!-- Card 3 -->
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s" style="cursor:pointer;"> 
                        <div class="feature-item p-4">
                    ...
                    <!-- Card 4 -->
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s" style="cursor:pointer;">
                        <div class="feature-item p-4">
                    ...
                    <!-- Card 5 -->
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s" style="cursor:pointer;">
                        <div class="feature-item p-4">
                            <div class="feature-icon mb-3"><i class="fas fa-check-circle text-white fa-3x"></i></div>
                            <a href="#" class="h4 mb-3">Kursus Selesai</a>
                            <p class="mb-3">Lihat kursus yang telah anda selesaikan.</p>
                            <br>
                        </div>
                    </div>
                    <!-- Card 6 -->
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s" style="cursor:pointer;">
                        <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-tasks text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Status Permohonan</a>
                                <p class="mb-3">Semak status pendaftaran anda.</p>
                        </div>
                    </div>
                    <!-- Card 7 -->
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s" style="cursor:pointer;">
                        <div class="feature-item p-4">
                            <div class="feature-icon mb-3"><i class="fas fa-star text-white fa-3x"></i></div>
                            <a href="#" class="h4 mb-3">Penilaian Kursus</a>
                            <p class="mb-3">Isi maklum balas kursus.</p>
                            <br> 
                            <br>
                        </div>
                    </div>
                    <!-- Card 8 -->
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.9s" style="cursor:pointer;">
                        <div class="feature-item p-4">
                        <div class="feature-icon mb-3"><i class="fas fa-certificate text-white fa-3x"></i></div>
                        <a href="#" class="h4 mb-3">Sijil Kursus</a>
                        <p class="mb-3">Muat turun sijil kursus anda.</p>
                        <br>
                        <br>
                        </div>
                    </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('formDaftarKursus').addEventListener('submit', function(e) {
                e.preventDefault();
                const nama = document.getElementById('namaKursus').value;
                const tarikh = document.getElementById('tarikh').value;
                if (nama && tarikh) {
                    calendar.addEvent({ title: nama, start: tarikh });
                    e.target.reset();
                    const modal = bootstrap.Modal.getInstance(document.getElementById('daftarKursusModal'));
                    modal.hide();
                }
                });
            });
