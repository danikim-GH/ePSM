...
class GovernmentLogin {
    ...
    async handleSubmit(e) {
        ...
        if (this.isLockedOut()) {
            this.showAlert('error', 'Too many failed attempts. Please wait before trying again.');
            return;
        }
        ...
        try {
            ...
            this.handleLoginError('Connection error. Please check your network and try again.');
        } finally {
